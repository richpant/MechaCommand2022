...
public class DriveSubsystem extends SubsystemBase {
  private final CANSparkMax m_frontLeft = new CANSparkMax(DriveConstants.FrontLeftID, MotorType.kBrushless);
  private final CANSparkMax m_rearLeft = new CANSparkMax(DriveConstants.RearLeftID, MotorType.kBrushless);
  private final CANSparkMax m_frontRight = new CANSparkMax(DriveConstants.FrontRightID,MotorType.kBrushless);
  private final CANSparkMax m_rearRight = new CANSparkMax(DriveConstants.RearRightID,MotorType.kBrushless);
